...
mk("sn2","Yogurt bianco",["morning_snack"],"snack",[{ingredientId:"yogurt",quantity:125,unit:"g"}],90),
...
mk("sn8","Yogurt con miele",["evening_snack"],"snack",[{ingredientId:"yogurt",quantity:125,unit:"g"},{ingredientId:"miele",quantity:1,unit:"tsp"}],100),
mk("lu1","Pasta al pomodoro e basilico",["lunch","first_course"],"cereals",[{ingredientId:"pasta",quantity:90,unit:"g"},{ingredientId:"pomodoro",quantity:180,unit:"g"},{ingredientId:"basilico",quantity:5,unit:"g"},{ingredientId:"olio_evo",quantity:1,unit:"tbsp"}],520),
...
mk("lu3","Pasta e ceci",["lunch","first_course"],"legumes",[{ingredientId:"pasta",quantity:80,unit:"g"},{ingredientId:"ceci_cotti",quantity:130,unit:"g"},{ingredientId:"cipolla",quantity:40,unit:"g"}],540),
...
mk("lu5","Pasta ricotta e zucchine",["lunch","first_course"],"cheese",[{ingredientId:"pasta",quantity:85,unit:"g"},{ingredientId:"ricotta",quantity:80,unit:"g"},{ingredientId:"zucchine",quantity:140,unit:"g"}],530),
...
mk("lu7","Pasta al tonno e limone",["lunch","first_course"],"fish",[{ingredientId:"pasta",quantity:85,unit:"g"},{ingredientId:"tonno_naturale",quantity:80,unit:"g"},{ingredientId:"limone",quantity:20,unit:"g"}],515),
